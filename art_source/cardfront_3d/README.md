...
当前参考布局为 2.0 × 2.0 × 2.7553 m，45 个独立 mesh、980 tris，
Common / Interceptor / Castle / Damage 四层共享地面中心原点。L1/L2/L3
使用 2/3/3 个大拦截构件，L3 另有反制炮口；HP3 保留裂纹，HP2 隐藏一块
完整护墙并显示破口/落地墙块，HP1 再隐藏完整穹盖与一根拦截臂，显示贴合顶圈的
坍塌顶板、断臂根、落臂和落地拦截板；HP0 保留 5 块逐块贴地、无玩法权威的
短时残骸。母版不保留 Camera/Light。四个生产
