...
func _test_pioneer_beacon_lite_effect() -> void:
	...
	var grid_size: int = int(fixture.battlefield.grid_size)
	var player_front_row: int = grid_size - CardfrontBattlefieldInitializerScript.get_spawn_rows(grid_size)
	var cell = Vector2i(3, player_front_row)
